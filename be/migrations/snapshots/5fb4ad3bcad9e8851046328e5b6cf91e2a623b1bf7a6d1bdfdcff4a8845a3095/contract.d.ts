...
export type StorageHash =
  StorageHashBase<'5fb4ad3bcad9e8851046328e5b6cf91e2a623b1bf7a6d1bdfdcff4a8845a3095'>;
export type ExecutionHash =
  ExecutionHashBase<'3301c318ca0f3c9536216d45d71aac4a59826b2106a16b70d9b6495d575a7db3'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Ride: {
      ...
      readonly departureTime: CodecTypes['pg/timestamptz-temporal@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Ride: {
      ...
      readonly departureTime: CodecTypes['pg/timestamptz-temporal@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly chatMessage: {
              ...
              indexes: readonly [
                {
                  readonly name: 'chatMessage_rideId_idx_2125d498';
                  readonly prefix: 'chatMessage_rideId_idx';
                  readonly columns: readonly ['rideId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'chatMessage_userId_idx_a489d58a';
                  readonly prefix: 'chatMessage_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'chatMessage_adminId_idx_530179db';
                  readonly prefix: 'chatMessage_adminId_idx';
            ...
            readonly rideRequest: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['rideId', 'userId'] }];
              indexes: readonly [
                {
                  readonly name: 'rideRequest_rideId_idx_2125d498';
                  readonly prefix: 'rideRequest_rideId_idx';
                  readonly columns: readonly ['rideId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'rideRequest_userId_idx_a489d58a';
                  readonly prefix: 'rideRequest_userId_idx';
                  readonly columns: readonly ['userId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'rideRequest';
                    readonly columns: readonly ['rideId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly valueSet: {
            readonly RideRequestStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['PENDING', 'ACCEPTED', 'REJECTED', 'CANCELLED'];
            };
            readonly RideStatus: {
              readonly kind: 'valueSet';
              readonly values: readonly ['SCHEDULED', 'CANCELLED', 'COMPLETED'];
            };
          };
        };
      };
